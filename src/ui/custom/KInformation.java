...
public class KInformation extends JDialog {
	...
	public KInformation() {
		...
		txtpnCryptonotepadVersion.setText(
				"\r\nThe Cypher Notepad was built for protecting user's data. It provides user-friendly security so that users don't need to worry about encryption. \r\n\r\nThe source code of this program may be found on Github, \"https://github.com/LeeDongGeon1996/Cypher-Notepad\". You are always welcome to press the \"follow\" and \"star\" button.");
